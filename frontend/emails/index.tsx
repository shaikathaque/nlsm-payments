  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
              ...
              <Section>
                <Row>
                  <Column style={informationTableColumn}>
                    ...
                    <Text style={informationTableValue}>Shaikat Haque</Text>
                  </Column>
                </Row>
                ...
                <Row>
                  <Column style={informationTableColumn}>
                    ...
                    <Text style={informationTableValue}>{(new Date()).toDateString()}</Text>
                  </Column>
                </Row>
              </Section>
            </Column>
        ...
        <Section>
          <Row>
            <Column style={{ width: "64px" }}>
              <Img
                src={`/static/nl-academy-logo.png`}
                width="64"
                height="64"
                alt="HBO Max"
                style={productIcon}
            ...
            <Column style={{ paddingLeft: "22px" }}>
              ...
              <Text style={productDescription}>Bashundhara (Sports Grill)</Text>
            </Column>

            <Column style={productPriceWrapper} align="right">
              <Text style={productPrice}>BDT 5,500</Text>
            </Column>
          </Row>
        </Section>
        ...
        <Section align="right">
          <Row>
            ...
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>BDT 5,500</Text>
            </Column>
          </Row>
        </Section>
        ...
        <Section>
          <Row>
            <Column align="center" style={ctaTitle}>
              <Text style={ctaText}>Thank you for being with NLSM</Text>
            </Column>
          </Row>
        </Section>
        ...
        {/* <Text style={footerTextCenter}></Text> */}
